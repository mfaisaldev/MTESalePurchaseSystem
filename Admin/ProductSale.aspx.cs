    ...
    public void CountWPP()
        {
            ...
            var result = (from p in DB.tblOrderDetails
                          select p);
            ...
            telenorColumn = new DataColumn();
            telenorColumn.ColumnName = "ProductName";
            telenorTable.Columns.Add(telenorColumn);
            ...
            Chart2.Series[1].XValueMember = "ProductName";

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerSale.aspx.cs" Inherits="Admin.CustomerSale" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-blue">
                                <div class="panel-heading">Customer Sale</div>
                                    ...
                                    <form id="form1" runat="server">
                                        <div class="auto-style1">
                                            <div style="float: left; margin-left: 50px; width: 90%">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceCus" Width="100%" DataKeyNames="OrderId" AllowPaging="True" PageSize="5">
                                                    <Columns>
                                                        <asp:BoundField DataField="OrderId" HeaderText="OrderId" SortExpression="OrderId" ReadOnly="True" Visible="false" />

                                                        <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" Visible="false" />
                                                        <asp:BoundField DataField="Expr1" HeaderText="Customer" SortExpression="Expr1" />
                                                    ...
                                                    <HeaderStyle CssClass="grdHeader" BackColor="#0a819c" ForeColor="White" />
                                                    <AlternatingRowStyle CssClass="grid_AlternateRow" />
                                                </asp:GridView>
                                                <asp:SqlDataSource ID="SqlDataSourceCus" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [OrderId], [ProductName], [Name], [Expr1], [CustomerNo], [ProductPrice], [OrderQty] FROM [View_Customer]"></asp:SqlDataSource>

                                                <div>
                                                    <asp:Chart ID="Chart2" runat="server" Height="400px" Width="1000px"
                                                        ...
                                                        <Series>
                                                            ...
                                                            <asp:Series ChartType="StackedColumn" Name="Series1" YValueType="Auto" Color="#336699"
                                                                IsValueShownAsLabel="True" YAxisType="Secondary" YValuesPerPoint="5" IsXValueIndexed="True" LabelForeColor="White" LabelBorderWidth="5">
                                                            </asp:Series>
